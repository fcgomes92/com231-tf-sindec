...
urlpatterns = [
    ...
    url(r'^relatorio/reclamacoes/ano/(?P<ano_inicial>[0-9]{4})/(?P<ano_final>[0-9]{4})/$',
        sindec_relatorio.RelatorioReclamacoesPorAnoRequestView.as_view(),
        name="relatorio_reclamacoes_por_ano"),
